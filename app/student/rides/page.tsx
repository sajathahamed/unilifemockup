    ...
    <DashboardLayout user={user}>
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="text-gray-500 text-sm mt-0.5">Book or share rides on campus</p>
        </div>
        <div className="bg-white rounded-2xl border border-gray-100 p-12 text-center">
          <Car size={48} className="mx-auto text-gray-300 mb-4" />
          <h2 className="text-lg font-semibold text-gray-700 mb-2">Coming soon</h2>
          <p className="text-gray-500 max-w-md mx-auto">
            Book campus shuttles or share rides with other students. This section can be extended later.
          </p>
        </div>
      </div>
    </DashboardLayout>
